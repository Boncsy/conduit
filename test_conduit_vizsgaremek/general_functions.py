...
def create_article(browser):
    ...
    article_title_input = WebDriverWait(browser, 15).until(EC.presence_of_element_located((By.XPATH, '//input[@placeholder="Article Title"]')))
...
def create_comment(browser):
    ...
    post_comment_button = WebDriverWait(browser, 15).until(EC.presence_of_element_located((By.XPATH, '//button[@class="btn btn-sm btn-primary"]')))
